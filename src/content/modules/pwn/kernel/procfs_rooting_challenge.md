...
The challenge source code should be placed in the `src/` folder and the exploit in the `exploit/` folder of the [orchestrator repo](https://github.com/fepfitra/kernel-pwn-minimal).
