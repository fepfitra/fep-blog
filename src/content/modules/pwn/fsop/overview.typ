...
= A Visual Guide to File Stream Oriented Programming (FSOP)
...
This module is based on the research presented in the whitepaper #link("https://gsec.hitb.org/materials/sg2018/WHITEPAPERS/FILE%2520Structures%2520-%2520Another%2520Binary%2520Exploitation%2520Technique%2520-%2520An-Jie%2520Yang.pdf")[FILE Structures: Another Binary Exploitation Technique] by An-Jie Yang.
