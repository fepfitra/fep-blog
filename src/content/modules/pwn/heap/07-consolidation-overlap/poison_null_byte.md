...
**Initial heap layout after setup.**
...
**Effect of the null byte on the victim chunk's metadata.**
...
**The result of the consolidation is a single large chunk that overlaps with `prev`.**
