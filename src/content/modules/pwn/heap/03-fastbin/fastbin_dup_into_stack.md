...
_The fastbin freelist is corrupted to `[ a, b, a ]`._
...
_A fake chunk is crafted on the stack. The allocator will see `0x20` as its size._
...
_The freelist head `a` now has its `fd` pointer aimed at our fake stack chunk._
