#metadata(
  (
    title: "Sandboxing Level 11",
    description: "Writeup for Sandboxing Level 11",
    date: "2026-01-01",
    order: 11,
  ),
)<frontmatter>
...
#table(
  ...
  [*Date*], [2025-12-30],
  [*Description*],
  [Using the nanosleep syscall to create a timing side-channel for leaking data when traditional output channels are blocked.],
)
