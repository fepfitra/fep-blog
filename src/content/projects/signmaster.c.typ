...
#metadata(
  (
    ...
    date: "2024-12-24",
    img: "/projects/thumbnail/sign-master.png",
    img_alt: "Sign Master Application",
    description: "This project is a sign language application for education that my team and I made as a final project for Bangkit Academy 2024",
    tags: (
      "Express JS",
      "Python",
...
- #link("https://www.kaggle.com/datasets/waseemnagahhenes/sign-language-dataset-wlasl-videos")[WLASL Dataset]
- #link("https://www.kaggle.com/datasets/ayuraj/asl-dataset")[ASL Dataset]

= DEPLOYED LINK

- #link("https://drive.google.com/drive/folders/15nGzLBBbhbpXyFJEK-mNcvSdUSFfDhCc")[Android APK]
- #link("https://signmaster-auth-kji5w4ybbq-et.a.run.app")[Auth Service]
- #link("wss://signmaster-inference-model-kji5w4ybbq-et.a.run.app")[ML Inference Service]
- #link("https://signmaster-tomotion-kji5w4ybbq-et.a.run.app")[Text to Sign Language Service]
- #link("https://signmaster-material-quiz-kji5w4ybbq-et.a.run.app")[Learning Material and Quiz Service]
- #link("https://signmaster-news-kji5w4ybbq-et.a.run.app")[News Service]
